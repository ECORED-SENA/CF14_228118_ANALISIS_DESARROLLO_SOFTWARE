  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 #[b Objetivo] Reforzar el conocimiento de la estructura básica de un documento HTML, y el propósito de las etiquetas fundamentales que componen la estructura de cualquier página web. 
