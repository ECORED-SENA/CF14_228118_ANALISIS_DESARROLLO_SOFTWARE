...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5(data-aos='fade-right') Para explicar este tipo de ejercicios, crearemos una base de datos de empleados llamada ‘ehr’. En esta base de datos, las tablas ‘empleados’ y ‘áreas’ están relacionadas de la siguiente manera: un empleado pertenece a un área y un área puede tener varios empleados, como se presenta en el siguiente diagrama: 
      br
      br
      |Note que area_id en la tabla empleados puede ser nuleable: 
    ...
    .row.justify-content-center.mb-5
      .col-lg-7.mb-lg-0.mb-3(data-aos="fade-right")
        .p-4(style="background-color: #f3f9ff ")
          p.mb-0 En esta operación, cada fila de la tabla 'empleados' se combina (o une) con las filas correspondientes de la tabla 'áreas' que cumplen con la condición especificada en el predicado del JOIN. Cualquier fila en la tabla 'empleados' o en la tabla 'áreas' que no tenga una correspondiente en la otra tabla será excluida; solo aquellas con correspondencias aparecerán en el resultado. Este es el tipo de JOIN más utilizado y es considerado la combinación predeterminada. 
        ...
        .tarjeta.p-4(style="background-color: #e8eefe ")
          .row.justify-content-center.align-items-center.mb-5
            .col-lg-7.mb-lg-0.mb-3
              p.mb-0 La condición de la relación, especificada como 𝑎.𝑖𝑑_𝑎𝑟𝑒𝑎=𝑒.𝑎𝑟𝑒𝑎_𝑖𝑑a, requiere que el valor esté presente en ambas tablas. Si un empleado tiene un valor NULL en 'area_id', no se incluirá en los resultados, ya que no puede cumplir con esta condición. Esto se ilustra mediante un Diagrama de Venn, donde solo la intersección (conjunción) representa los registros que coinciden en ambas tablas. 
            .col-lg-5.col-7: img(src='@/assets/curso/temas/47.png', alt='La imagen presenta una diagramación de Empleados y areas.')
    p.mb-5(data-aos='fade-right') Existen otros tipos de consultas como #[b FULL JOIN, FULL OUTER JOIN y CROSS JOIN] que no se tratarán en detalle debido a su uso menos frecuente. Sin embargo, con una comprensión básica del concepto principal, es posible acceder a la documentación en línea para explorar cómo funcionan estos JOINs. 
      br
      br
      ...
      .row.justify-content-center.mb-5
        ...
        .col-lg-4
          .p-4.tarjeta(style="background-color: #ffefaf ") 
            p.mb-0 El resultado de este tipo de consulta incluye todos los registros de la tabla de la izquierda (la primera tabla definida en la cláusula #[b FROM] de la consulta), independientemente de si existe un registro correspondiente en la tabla de la derecha (la definida en el #[b JOIN]). 
      p.mb-5(data-aos='fade-right') La sentencia LEFT JOIN empareja todos los valores de la tabla izquierda (empleados) con los valores correspondientes de la tabla derecha (áreas), si existen. Si no hay correspondencia, retorna un valor nulo (NULL) en los campos de la tabla derecha. 
        br
        br
        |A diferencia de lo que ocurre con un INNER JOIN, donde no se muestra un empleado cuya área no existe, el LEFT JOIN incluirá estos empleados. En el diagrama asociado, el empleado sin área asignada aparece en la región amarilla, mientras que los empleados con área asignada se muestran en la franja naranja, en la intersección de las tablas de empleados y áreas. 
      .row.justify-content-center.mb-5
        .col-lg-8(data-aos="zoom-in")
          .titulo-sexto.color-acento-contenido(data-aos='fade-right')
            h5 Figura 8. 
    ...
    .f-2-2.p-5.mn.mb-5
      ...
      p.mb-5(data-aos='fade-right') La sentencia RIGHT JOIN devuelve todos los valores de la tabla derecha (áreas), emparejados con los valores correspondientes de la tabla izquierda (empleados), si existen. Si no hay correspondencia, se retorna un valor nulo (NULL) para los campos de la tabla izquierda. 
        br
        br
        |Esta operación garantiza que todos los registros de la tabla derecha estén presentes en el resultado, mientras que los registros de la tabla izquierda que no tengan correspondencia se representarán con valores nulos.
      .row.justify-content-center.mb-5
        .col-lg-4.mb-lg-0.mb-3(data-aos="fade-right")
          .tarjeta-codigo.p-2.mb-5
              pre.language-html(language="html").mt-5
        ...
        .col-lg-4.mb-lg-0.mb-3: img(src='@/assets/curso/temas/51.svg', alt='La imagen presenta un diagrama que representa las areas que tienen y no empleados.')
        .col-lg-4
          .p-4.tarjeta(style="background-color: #ffefaf ") 
      ...
      .row.justify-content-center.mb-5
        .col-lg-8(data-aos="zoom-in")
          ...
          img(src='@/assets/curso/temas/52.png', alt='La imagen presenta  la aplicación de areas y empleados.')
